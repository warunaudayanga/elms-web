 ...
 * MeetingInfoType
 */
export type MeetingInfoType = "topic" | "host" | "mn" | "pwd" | "telPwd" | "invite" | "participant" | "dc" | "enctype" | "report";
/**
 ...
 * ```js
 * IZoomMtg.i18n.load('en-US');
  var userLangTemplate = IZoomMtg.i18n.getAll("en-US");
  ...
  IZoomMtg.i18n.load(userLangDict, "myLang");
  IZoomMtg.i18n.reload('myLang');
 * ```
 */
export declare namespace IZoomMtgLang {
    /**
     * Loads translations.
 ...
 * IZoomMtg
 */
export namespace IZoomMtg {
    /**
     * i18n
     * @
     */
    const i18n: typeof IZoomMtgLang;
    /**
     ...
     * Default is IZoomMtg.setZoomJSLib('https://source.zoom.us/{VERSION_NUMBER}/lib', '/av')
     * @category Join
     */
     ...
     * Use IZoomMtg.inMeetingServiceListener('onClaimStatus', function(e){}) to listen for the claim result.
   ...
   * Example:
  ```js
  IZoomMtg.inMeetingServiceListener('onUserJoin', function (data) {
    console.log(data);
  });

  IZoomMtg.inMeetingServiceListener('onUserLeave', function (data) {
    console.log(data);
  });

  IZoomMtg.inMeetingServiceListener('onUserUpdate', function (data) {
    console.log(data);
  });
  ```
  @category Listener
   ...
   * Example:
   * ```js
  IZoomMtg.inMeetingServiceListener('receiveSharingChannelReady', function (data) {
    console.log(data);
  });
  ```
  @category Listener
  ...
  IZoomMtg.inMeetingServiceListener('onUserIsInWaitingRoom', function (data) {
    console.log(data);
  });

  IZoomMtg.inMeetingServiceListener('onPreviewPannel', function (data) {
   ...
   * Example:
   * ```js
  IZoomMtg.inMeetingServiceListener('onMeetingStatus', function (data) {
  ...
  IZoomMtg.inMeetingServiceListener('onReceiveTranscriptionMsg', function (data) {
    console.log('onReceiveTranscriptionMsg', data);
  });

  IZoomMtg.inMeetingServiceListener('onReceiveTranslateMsg', function (data) {
   ...
   * Example:
   * ```js
  IZoomMtg.inMeetingServiceListener('onAudioQos', function (data) {
    console.log('onAudioQos', data);
  });

  IZoomMtg.inMeetingServiceListener('onVideoQos', function (data) {
   ...
   * Example:
   * ```js
  IZoomMtg.inMeetingServiceListener('onClaimStatus', function (data) {
    console.log(data);
  });
  ```
  @category Listener
   ...
   * Example:
  ```js
  IZoomMtg.inMeetingServiceListener('onNetworkQualityChange', function (data) {
